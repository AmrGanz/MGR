...
MGR "_not the final name_" is a simple TUI interface to navigate through and view OpenShift 4 must-gather files.
...
~~~
- The main interface is divided into multiple areas as shown in the following screenshot (the following screenshot may not reflect the latest MGR version):
...
- To go back to the main interface, press the `Esc` key in your keyboard.
...
- Note: (the following screenshot may not reflect the latest MGR version)
